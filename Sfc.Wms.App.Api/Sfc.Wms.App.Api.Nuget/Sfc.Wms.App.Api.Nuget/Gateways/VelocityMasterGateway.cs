...
namespace Sfc.Wms.App.Api.Nuget.Gateways
{
    public class VelocityMasterGateway : SfcBaseGateway, IVelocityMasterGateway
    {
        ...
        public VelocityMasterGateway(IResponseBuilder responseBuilders, IRestClient restClient) : base(restClient)
        {
        ...
        public async Task<BaseResult<string>> GetVelocityMasterDetailsAsync(VelocityMasterModel velocityMasterModel,
            string token)
        {
        ...
        {
            var resource =
                $"{_endPoint}/{Routes.Paths.SearchVelocityMaster}{Routes.Paths.QueryParamSymbol}pageNo={velocityMasterModel.pageNo}{Routes.Paths.QueryParamAnd}rowsPerPage={velocityMasterModel.rowsPerPage}{Routes.Paths.QueryParamAnd}totalRows={velocityMasterModel.totalRows}";
