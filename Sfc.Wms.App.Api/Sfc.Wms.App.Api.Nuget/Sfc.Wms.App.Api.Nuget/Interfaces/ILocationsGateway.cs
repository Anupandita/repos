...
namespace Sfc.Wms.App.Api.Nuget.Interfaces
{
    public interface ILocationsGateway
    {
        ...
        Task<BaseResult<string>> UpdateActiveLocationsDrilldown(
        ...
        Task<BaseResult<string>> UpdateLocationGroupById(ActiveLocationGroupModel activeLocationGroupModel,
            string token);
        ...
        Task<BaseResult<string>> UpdateReserveLocationnDrillDown(
        ...
        Task<BaseResult<string>> AddToLocationGroup(AddActiveLocationGroupModel addActiveLocationGroupModel,
            string token);
    }
}