namespace Sfc.Wms.Api.Asrs.Test.Integrated.TestData
{
    ...
    public class ComtQueries
    {
        ...
        public static string ReceivedCaseFromReturns = $"select CASE_HDR.cons_prty_date,CASE_HDR.PO_NBR,CASE_HDR.CASE_NBR,CASE_HDR.LOCN_ID,CASE_HDR.STAT_CODE from CASE_HDR " + CommonJoin +"  " +
            ...
            "sc.code_id = :sysCodeId) and CASE_DTL.actl_qty >= 1  and CASE_DTL.CASE_SEQ_NBR = :seqNbr  and CASE_DTL.actl_qty <= pl.MAX_INVN_QTY - (pl.ACTL_INVN_QTY + pl.TO_BE_FILLD_QTY - pl.TO_BE_PIKD_QTY)  " +
        ...
        public static string ReceivedCaseFromVendors = $"select CASE_HDR.cons_prty_date,CASE_HDR.PO_NBR,CASE_HDR.CASE_NBR,CASE_HDR.LOCN_ID,CASE_HDR.STAT_CODE from  CASE_HDR " +
            ...
            "where CASE_DTL.total_alloc_qty >= 1 and CASE_DTL.actl_qty>= 1 and CASE_DTL.CASE_SEQ_NBR = :seqNbr and " +
