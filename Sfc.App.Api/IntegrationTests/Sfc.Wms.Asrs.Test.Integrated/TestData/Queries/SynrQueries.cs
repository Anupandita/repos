...
namespace Sfc.Wms.Api.Asrs.Test.Integrated.TestData
{
    ...
    public class SynrQueries
    {
        ...
        public const string SynrDataQty = "select SUM(SWM_SYND_DATA.Quantity) from SWM_SYND_DATA where SYNCHRONIZATION_ID = :syncId and SKU = :skuId";
