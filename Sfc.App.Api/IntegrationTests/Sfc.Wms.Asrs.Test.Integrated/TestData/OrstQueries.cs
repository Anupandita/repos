namespace Sfc.Wms.Api.Asrs.Test.Integrated.TestData
{
    ...
    public class OrstQueries
    {
        ...
        public static string ValidDataForInsertingOrstMessage = $"select sm.order_id,sm.sku_id,sm.qty,sm.msg_json,ch.curr_locn_id,pl.locn_id,ph.ship_w_ctrl_nbr,ch.dest_locn_id from swm_to_mhe sm " +
        ...
        public static string MsgToSourceView = $"select * from msg_to_sv where message_type='USL' and PTN= :cartonNo";
