...
namespace Sfc.Wms.Api.Asrs.Test.Integrated.TestData
{
    public class OrmtQueries
    {
        ...
        public const string CommonSelect = "select distinct eg.CARTON_NBR,eg.CREATED_DATE_TIME,ch.wave_nbr,ch.sku_id,pl.locn_id,ch.MISC_NUM_1," +
        ...
        public const string CommonJoin = "inner join carton_hdr ch on ch.Carton_Nbr = eg.Carton_Nbr inner join PKT_HDR ph ON ph.pkt_ctrl_nbr = ch.pkt_ctrl_nbr " +
        ...
        public const string ActiveLocnNotFound = "select ch.carton_nbr,ch.sku_id,pl.locn_id,ch.wave_nbr from carton_hdr ch inner join " +
