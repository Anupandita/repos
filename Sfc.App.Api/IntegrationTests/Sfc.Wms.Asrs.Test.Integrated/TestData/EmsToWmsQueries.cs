...
namespace Sfc.Wms.Api.Asrs.Test.Integrated.TestData
{
    ...
    {
        public const string CostQuery= "select swm_to_mhe.container_id,swm_to_mhe.sku_id,pick_locn_dtl.locn_id,swm_to_mhe.qty from swm_to_mhe inner join trans_invn" +
        ...
        public const string CostFetchDataWithOutTransInvn = "select cd.SKU_ID,ch.CASE_NBR,tn.ACTL_INVN_UNITS,ch.STAT_CODE,pick_locn_dtl.locn_id from CASE_HDR ch  " +
