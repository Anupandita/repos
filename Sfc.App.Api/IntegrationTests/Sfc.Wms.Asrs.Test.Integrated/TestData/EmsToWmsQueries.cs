namespace Sfc.Wms.Api.Asrs.Test.Integrated.TestData
{
    ...
    {
        public static string CostQuery= $"select swm_to_mhe.container_id,swm_to_mhe.sku_id,pick_locn_dtl.locn_id,swm_to_mhe.qty from swm_to_mhe inner join trans_invn" +
