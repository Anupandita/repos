...
{
    public abstract class EmsToWmsGatewayFixture
    {
        private readonly EmsToWmsGateway _emsToWmsGateway;

        private readonly Mock<IRestClient> _restClient;
        private BaseResult<IEnumerable<EmsToWmsDto>> getAllTestResult;
        private BaseResult<EmsToWmsDto> getDetailsTestResult;
        private BaseResult manipulationTestResult;

        protected EmsToWmsGatewayFixture()
        {
            _restClient = new Mock<IRestClient>();
            _emsToWmsGateway = new EmsToWmsGateway(_restClient.Object);
        }
        ...
        protected void GetAllInvoked()
        {
            ...
            {
                Payload = Generator.Default.List<EmsToWmsDto>(),
        ...
        {
            var result = new BaseResult<EmsToWmsDto>
            {
                Payload = Generator.Default.Single<EmsToWmsDto>(),
                ResultType = ResultTypes.Ok
            };
            GetRestResponse1(result, HttpStatusCode.OK, ResponseStatus.Completed);
        }
        ...
        protected void InputDataWithrWhichRecordAlreadyExist()
        {
            var result = new BaseResult<bool> {Payload = true, ResultType = ResultTypes.Conflict};
            GetRestResponse1(result, HttpStatusCode.OK, ResponseStatus.Completed);
        }
        ...
        {
            manipulationTestResult = _emsToWmsGateway.InsertAsync(It.IsAny<EmsToWmsDto>()).Result;
        }
        ...
        {
            manipulationTestResult = _emsToWmsGateway.UpdateAsync(It.IsAny<EmsToWmsDto>()).Result;
        }
        ...
        {
            var result = new BaseResult<EmsToWmsDto>
                {Payload = Generator.Default.Single<EmsToWmsDto>(), ResultType = ResultTypes.NotFound};
            GetRestResponse1(result, HttpStatusCode.OK, ResponseStatus.Completed);
        }
        ...
        {
            var result = new BaseResult<EmsToWmsDto>
                {Payload = Generator.Default.Single<EmsToWmsDto>(), ResultType = ResultTypes.Ok};
            GetRestResponse1(result, HttpStatusCode.OK, ResponseStatus.Completed);
        }
